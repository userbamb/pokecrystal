	...
	tilepal 0, ROOF, ROOF, ROOF, GREEN, WATER, GREEN, BROWN, YELLOW
	tilepal 0, YELLOW, YELLOW, BROWN, BROWN, BROWN, GREEN, GREEN, GREEN
...
endr
	...
	tilepal 1, ROOF, GRAY, YELLOW, GRAY, GRAY, TEXT
