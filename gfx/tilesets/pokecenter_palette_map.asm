	...
	tilepal 0, YELLOW, YELLOW, RED, RED, WATER, WATER, GRAY, GRAY
	tilepal 0, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY
	tilepal 0, YELLOW, YELLOW, RED, RED, GRAY, WATER, WATER, WATER
...
endr
	...
	tilepal 1, GREEN, GREEN, GRAY, WATER, WATER, WATER, ROOF, ROOF
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, WATER, WATER, WATER
	tilepal 1, GREEN, GREEN, RED, WATER, WATER, WATER, WATER, WATER
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GREEN, GREEN, GRAY
	tilepal 1, RED, RED, RED, RED, WATER, WATER, GRAY, GRAY
