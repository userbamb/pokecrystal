...
; flying or underground, or underwater and slower than the enemy.
...
; Dismiss this move if the player is flying or underground. or underwater
	ld a, [wPlayerSubStatus3]
	and 1 << SUBSTATUS_FLYING | 1 << SUBSTATUS_UNDERGROUND
...
; Greatly encourage this move if the player is
; flying or underground, underwater and slower than the enemy.
