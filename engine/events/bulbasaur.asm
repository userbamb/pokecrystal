GiveBulbasaur:
; if wScriptVar is 0 or 1, change the moveset of the last Bulbasaur in the party.
;  0: give it a special moveset with Extremespeed.
;  1: give it the normal moveset of a level 15 Bulbasaur.
...
.CheckForBulbasaur:
; start at the end of the party and search backwards for a Bulbasaur
	ld a, [hl]
	cp BULBASAUR
	jr z, .GiveMoveset
	ld a, l
