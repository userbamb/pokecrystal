GiveSquirtle:
; if wScriptVar is 0 or 1, change the moveset of the last Squirtle in the party.
;  0: give it a special moveset with Extremespeed.
;  1: give it the normal moveset of a level 15 Squirtle.
...
.CheckForSquirtle:
; start at the end of the party and search backwards for a Squirtle
	ld a, [hl]
	cp SQUIRTLE
	jr z, .GiveMoveset
	ld a, l
