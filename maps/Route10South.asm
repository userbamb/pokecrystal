...
Route10South_MapEvents:
	...
	def_warp_events
	warp_event 13,  3, ROCK_TUNNEL_1F, 2
	...
	object_event 14, 12, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerPokefanmRobert, -1
