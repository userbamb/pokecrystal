...
CianwoodCity_MapEvents:
	...
	bg_event  9, 17, BGEVENT_ITEM, CianwoodCityHiddenRevive
	bg_event  4, 25, BGEVENT_ITEM, CianwoodCityHiddenMaxEther
	...
	object_event  6, 21, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	...
	object_event 11, 10, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
