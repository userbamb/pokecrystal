...
LavenderTown_MapEvents:
	...
	def_warp_events
	warp_event  8,  5, LAVENDER_POKECENTER_1F, 1
	warp_event 11,  9, MR_FUJIS_HOUSE, 1
	warp_event  9, 13, LAVENDER_SPEECH_HOUSE, 1
	...
	def_bg_events
	bg_event 10,  5, BGEVENT_READ, LavenderTownSign
	bg_event 17,  5, BGEVENT_READ, KantoRadioStationSign
	bg_event  9,  9, BGEVENT_READ, VolunteerPokemonHouseSign
	bg_event 21, 13, BGEVENT_READ, SoulHouseSign
	bg_event 11,  5, BGEVENT_READ, LavenderPokecenterSignText

	def_object_events
	object_event 20,  7, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, LavenderTownPokefanMScript, -1
	object_event  9, 15, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, LavenderTownTeacherScript, -1
	object_event 22, 12, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LavenderTownGrampsScript, -1
	object_event 13, 10, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 1, LavenderTownYoungsterScript, -1
