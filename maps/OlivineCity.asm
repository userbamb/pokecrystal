...
OlivineCity_MapEvents:
	...
	def_warp_events
	warp_event  9, 21, OLIVINE_POKECENTER_1F, 1
	...
	warp_event  3, 21, OLIVINE_CAFE, 1
	...
	bg_event 10, 21, BGEVENT_READ, OlivineCityPokecenterSign
	...
	object_event 21, 19, SPRITE_SAILOR, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCitySailor2Script, -1
