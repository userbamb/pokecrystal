...
.Position1:
	...
	moveobject ILEXFOREST_FARFETCHD, 15, 35
...
.Position2:
	...
	moveobject ILEXFOREST_FARFETCHD, 20, 34
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position2_Down:
	...
	moveobject ILEXFOREST_FARFETCHD, 15, 39
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position3:
	...
	moveobject ILEXFOREST_FARFETCHD, 29, 32
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position4:
	...
	moveobject ILEXFOREST_FARFETCHD, 28, 41
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position5:
	...
	moveobject ILEXFOREST_FARFETCHD, 24, 45
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position5_Left:
	...
	moveobject ILEXFOREST_FARFETCHD, 22, 41
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position8:
	...
	moveobject ILEXFOREST_FARFETCHD, 10, 45
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
.Position9:
	...
	moveobject ILEXFOREST_FARFETCHD, 6, 38
	disappear ILEXFOREST_FARFETCHD
	appear ILEXFOREST_FARFETCHD
...
IlexForest_MapEvents:
	...
	def_warp_events
	warp_event  5,  5, ROUTE_34_ILEX_FOREST_GATE, 3
	warp_event  3, 52, ILEX_FOREST_AZALEA_GATE, 1
	warp_event  3, 53, ILEX_FOREST_AZALEA_GATE, 2
	warp_event  3, 53, ILEX_FOREST_AZALEA_GATE, 2
	warp_event 25, 50, LUCKY_SPOT, 1
	warp_event 25, 51, LUCKY_SPOT, 2
	def_coord_events

	def_bg_events
	bg_event  3, 29, BGEVENT_READ, IlexForestSignpost
	bg_event 10,  9, BGEVENT_ITEM, IlexForestHiddenEther
	bg_event 25, 22, BGEVENT_ITEM, IlexForestHiddenSuperPotion
	bg_event  1, 22, BGEVENT_ITEM, IlexForestHiddenFullHeal
	...
	object_event 20,  6, SPRITE_ROCKER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IlexForestHeadbuttGuyScript, -1
	...
	object_event  9, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 0, TrainerBugCatcherWayne, -1
	object_event 24,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IlexForestXAttack, EVENT_ILEX_FOREST_X_ATTACK
	object_event 18, 14, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IlexForestAntidote, EVENT_ILEX_FOREST_ANTIDOTE
	object_event 28,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IlexForestEther, EVENT_ILEX_FOREST_ETHER
