...
LakeOfRage_MapEvents:
	...
	def_warp_events
	warp_event  7,  5, LAKE_OF_RAGE_HIDDEN_POWER_HOUSE, 1
	...
	object_event 23, 18, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RedGyarados, EVENT_LAKE_OF_RAGE_RED_GYARADOS
