...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	...
	const EVENT_GOT_HM08_DIVE ; unused
; Rods
...
; Johto hidden items
	...
	const EVENT_FOUND_HELIX ; unused in Crystal
	const  EVENT_FOUND_DOME ; unused in Crystal
	const EVENT_FOUND_AMBER ; unused in Crystal
...
; Kanto story events
	...
	const EVENT_APPEARS_ZAPDOS
	const EVENT_APPEARS_ARTICUNO
	const EVENT_APPEARS_MOLTRES
...
; Kanto hidden items
	...
	const EVENT_GOT_UNDERWATER_NUGGET1 ;
	const EVENT_GOT_UNDERWATER_RARECANDY1 ;
	const EVENT_GOT_UNDERWATER_WATER_STONE ;
	const EVENT_GOT_UNDERWATER_OLD_MAP ;
	const EVENT_GOT_UNDERWATER_HP_UP ;
	const EVENT_GOT_UNDERWATER_PEARL ;
	const EVENT_GOT_UNDERWATER_BIG_PEARL1 ;
	const EVENT_GOT_UNDERWATER_DRAGON_SCALE ;
	const EVENT_GOT_UNDERWATER_NUGGET2 ;
	const EVENT_GOT_UNDERWATER_RARECANDY2 ;
	const EVENT_GOT_UNDERWATER_BIG_PEARL2 ;
	const EVENT_UNDERWATER_LABI_ITEM1; 
	const EVENT_UNDERWATER_LABI_ITEM2 ;
	const EVENT_UNDERWATER_LABI_ITEM3 ;
	const EVENT_UNDERWATER_LAKE_ITEM1 ;
	const EVENT_UNDERWATER_LAKE_ITEM2 ;
...
; Psychic
	...
	const EVENT_BEAT_PSYCHIC_WESLEY
; Firebreather
...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLBOY_ARTHUR
	const EVENT_BEAT_SCHOOLBOY_SANTOS
; Picnicker
...
; Beauty
	...
	const EVENT_BEAT_BEAUTY_MONICA
...
; New to Crystal
	...
	const EVENT_SAFARI_ZONE_EAST_CARBOS            ;starts the 48 here
	...
	const EVENT_SAFARI_ZONE_MEW_SCARED
	const EVENT_VERMILION_HUB_KEYS
	const EVENT_CERULEAN_CAVE_1F_POTION
	const EVENT_CERULEAN_CAVE_1F_FULL_HEAL
	const EVENT_CERULEAN_CAVE_1F_HYPER_POTION
	const EVENT_CERULEAN_CAVE_1F_DIRE_HIT
	const EVENT_CERULEAN_CAVE_2F_POTION
	const EVENT_CERULEAN_CAVE_2F_FULL_HEAL
	const EVENT_CERULEAN_CAVE_2F_HYPER_POTION
	const EVENT_CERULEAN_CAVE_2F_DIRE_HIT
	const EVENT_FOUGHT_MEWTWO
	const EVENT_CERULEANB1F_MEWTWO
	const EVENT_VIRIDIAN_FOREST_REVIVE
	const EVENT_OPENED_CERUCAVE
	const EVENT_CINNABAR_1F_STATUE_1
	const EVENT_CINNABAR_1F_STATUE_2
	const EVENT_CINNABAR_1F_STATUE_3
	const EVENT_CINNABAR_1F_STATUE_4
	const EVENT_CINNABAR_1F_STATUE_5
