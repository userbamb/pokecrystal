...
; New to Crystal
	...
	EVENT_CERULEAN_CAVE_1F_POTION
	EVENT_CERULEAN_CAVE_1F_FULL_HEAL
	EVENT_CERULEAN_CAVE_1F_HYPER_POTION
	EVENT_CERULEAN_CAVE_1F_DIRE_HIT
	EVENT_CERULEAN_CAVE_2F_POTION
	EVENT_CERULEAN_CAVE_2F_FULL_HEAL
	EVENT_CERULEAN_CAVE_2F_HYPER_POTION
	EVENT_CERULEAN_CAVE_2F_DIRE_HIT
	EVENT_FOUGHT_MEWTWO
	EVENT_CERULEANB1F_MEWTWO
