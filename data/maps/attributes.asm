...
ENDM
	...
	map_attributes CeladonMansionRoofR, CELADON_MANSION_ROOFR, $01, 0
	map_attributes CeladonMansionRoofL, CELADON_MANSION_ROOFL, $01, 0
	...
	map_attributes CeruleanMewtwo, CERULEAN_MEWTWO, $00, 0
