...
MapGroup_Fuchsia:
	...
	map SafariZoneFuchsiaGate, TILESET_GATE, GATE, FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
map SafariZoneHub, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneNorth, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneWest, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneHubRestHouse, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneEastRestHouse, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneNorthRestHouse, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWestRestHouse1, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWestRestHouse2, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
