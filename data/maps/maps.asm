...
MapGroup_Viridianfor:
	...
	map ViridianGateSouth, TILESET_GATE, GATE, LANDMARK_CERULEAN_CAVE, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianGateNorth, TILESET_FOREST, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CERUCAVE_MAPS
