...
MapGroup_Cerucave:
	...
	map CeruleanCave1F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCave2F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCaveB1F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanMewtwo, TILESET_CERUCAVE, INDOOR, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
