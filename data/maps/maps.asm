...
MapGroup_Safari:
	...
	map SafariZoneNorth, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Underwater:
	...
	map Cinnabar1F, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
