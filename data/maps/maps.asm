...
MapGroup_Safari:
	...
	map SafariZoneNorth, TILESET_SAFARI, ENVIRONMENT_5, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Underwater:
	...
	map DragonUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map LakeUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RuinUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map UnderwaterLabi, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CinnabarUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map Cinnabar1F, TILESET_UNDERWATER, ENVIRONMENT_5, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS , TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CianwoodUnderwater, TILESET_UNDERWATER, ENVIRONMENT_5, LANDMARK_UNDERWATER, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
