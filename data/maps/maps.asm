...
MapGroup_Safari:
	...
	map SafariZoneHub, TILESET_SAFARI, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_SAFARI, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneNorth, TILESET_SAFARI, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
