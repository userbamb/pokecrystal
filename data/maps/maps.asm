...
MapGroup_Dungeons:
	...
	map NationalPark, TILESET_PARK, ENVIRONMENT_5, LANDMARK_NATIONAL_PARK, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map IcePath1F, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map IcePathB1F, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map IcePathB2FMahoganySide, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map IcePathB2FBlackthornSide, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map IcePathB3F, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	...
	map LuckySpot, TILESET_FOREST, INDOOR, LANDMARK_ILEX_FOREST, MUSIC_GAME_CORNER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map Route10NorthInside, TILESET_KANTO, ENVIRONMENT_5, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Violet:
	...
	map Route32, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_CHINCHOU
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStoreRoof, TILESET_MART, ENVIRONMENT_5, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterLab, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map Route23, TILESET_KANTO_MODERN, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route13, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_CHINCHOU_NO_SWARM
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_CHINCHOU_NO_SWARM
	map Route10South, TILESET_KANTO_MODERN, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map LavenderTown, TILESET_KANTO_MODERN, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route8LavenderGate, TILESET_GATE, GATE, LANDMARK_ROUTE_8, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12LavenderGate, TILESET_GATE, GATE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map SilverCaveOutsideInside, TILESET_KANTO, ENVIRONMENT_5, LANDMARK_SILVER_CAVE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_NONE	
...
MapGroup_CableClub:
	...
	map TradeCenter, TILESET_GATE, INDOOR, LANDMARK_SPECIAL, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Colosseum, TILESET_GATE, INDOOR, LANDMARK_SPECIAL, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonMansionRoofL, TILESET_MANSION, ENVIRONMENT_5, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map BattleTowerOutside, TILESET_BATTLE_TOWER_OUTSIDE, ENVIRONMENT_5, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Safari:
    table_width MAP_LENGTH, MapGroup_Safari
	map SafariZoneFuchsiaGate, TILESET_GATE, GATE, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneHub, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneNorth, TILESET_SAFARI, ENVIRONMENT_5, LANDMARK_SAFARI_ZONE, MUSIC_NATIONAL_PARK, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_SAFARI_MAPS

MapGroup_Cerucave:
    table_width MAP_LENGTH, MapGroup_Cerucave
	map CeruleanCave1F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_MORN, FISHGROUP_DRATINI
	map CeruleanCave2F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_MORN, FISHGROUP_DRATINI
	map CeruleanCaveB1F, TILESET_CERUCAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_MORN, FISHGROUP_DRATINI
	assert_table_length NUM_CERUCAVE_MAPS

MapGroup_Viridianfor:
    table_width MAP_LENGTH, MapGroup_Viridianfor
	map ViridianForest, TILESET_FOREST, CAVE, LANDMARK_VIRIDIAN_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ViridianGateSouth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Underwater:
	...
	map Underwater1, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map DragonUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map LakeUnderwater, TILESET_UNDERWATER, ENVIRONMENT_5, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RuinUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map UnderwaterLabi, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CinnabarUnderwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map Cinnabar1F, TILESET_UNDERWATER, ENVIRONMENT_5, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS , TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CianwoodUnderwater, TILESET_UNDERWATER, ENVIRONMENT_5, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map Route41Underwater, TILESET_UNDERWATER, ROUTE, LANDMARK_UNDERWATER, MUSIC_POST_CREDITS, TRUE, PALETTE_NITE, FISHGROUP_NONE
