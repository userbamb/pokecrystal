...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH,  EFFECT_PRIORITY_HIT,       75, STEEL,          PHYSICAL,   95, 15,   0
	...
	move CUT,          EFFECT_ALWAYS_HIT,         70, FLYING,        PHYSICAL,   100, 30,   0
	move GUST,         EFFECT_GUST,               90, FLYING,        SPECIAL,    100, 35,   0
	...
	move BIND,         EFFECT_TRAP_TARGET,        35, NORMAL,        PHYSICAL,    100, 20,   0
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        PHYSICAL,    75, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         70, GRASS,         PHYSICAL,   100, 10,   35
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         70, FIGHTING,      PHYSICAL,    95, 15,  40
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,        STATUS,     100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,        PHYSICAL,   100, 15,  40
	...
	move BITE,         EFFECT_FLINCH_HIT,         70, DARK,          PHYSICAL,   100, 25,  35
	move GROWL,        EFFECT_ATTACK_DOWN,         0, NORMAL,        STATUS,     100, 40,   0
	move ROAR,         EFFECT_FORCE_SWITCH,        0, NORMAL,        STATUS,     100, 20,   0
	move SING,         EFFECT_SLEEP,               0, NORMAL,        STATUS,      95, 15,   0
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        STATUS,      95, 20,   0
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      40, NORMAL,        PHYSICAL,    90, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        STATUS,      95, 20,   0
	...
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,       70, NORMAL,      PHYSICAL,   100, 15,  100
	...
	move ROCK_THROW,   EFFECT_SPEED_DOWN_HIT,     65, ROCK,          PHYSICAL,    100, 15, 100
	...
	move TOXIC,        EFFECT_TOXIC,               0, POISON,        STATUS,      95, 10,   0
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE,  SPECIAL,    100, 25,  10
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_TYPE,  SPECIAL,    100, 10,  20
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE,  STATUS,      90, 20,   0
	move MEDITATE,     EFFECT_ATTACK_UP_2,           0, PSYCHIC_TYPE,  STATUS,     100, 20,   0
	...
	move DOUBLE_TEAM,  EFFECT_EVASION_UP_2,        0, NORMAL,        STATUS,     100, 15,   0
	...
	move BIDE,         EFFECT_BIDE,                0, NORMAL,        SPECIAL,    100, 10,   0
	...
	move LICK,         EFFECT_PRIORITY_HIT,       80, GHOST,         PHYSICAL,   100, 10,   0
	...
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,          SPECIAL,     90, 15,  10
	move WATERFALL,    EFFECT_PRIORITY_HIT,       80, WATER,         PHYSICAL,   100, 15,   0
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,         PHYSICAL,    75, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,        SPECIAL,    100, 20,   0
	move SKULL_BASH,   EFFECT_FLINCH_HIT,         90, ROCK,          PHYSICAL,   100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          30, STEEL,         PHYSICAL,   100, 15,   0
	...
	move SKY_ATTACK,   EFFECT_RECOIL_HIT,        120, FLYING,        PHYSICAL,    90, 10,   0
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_2,     0, NORMAL,        STATUS,      70, 20,   0
	...
	move CRABHAMMER,   EFFECT_FLINCH_HIT,         80, WATER,         PHYSICAL,   100, 10,  30
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         85, ROCK,          PHYSICAL,    90, 10,  30
	...
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         90, NORMAL,        SPECIAL,    100, 10,  40
	...
	move FLAME_WHEEL,  EFFECT_RECOIL_HIT,        120, FIRE,          PHYSICAL,   100, 10,   0
	...
	move POWDER_SNOW,  EFFECT_PRIORITY_HIT,       65, ICE,           PHYSICAL,   100, 25,   0
	move PROTECT,      EFFECT_PROTECT,             0, NORMAL,        STATUS,     100, 10,   0
	move MACH_PUNCH,   EFFECT_PRIORITY_HIT,       85, FIGHTING,      PHYSICAL,   100, 10,   0
	...
	move OCTAZOOKA,    EFFECT_BURN_HIT,           85, WATER,         SPECIAL,    95, 10,  80
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     65, ICE,           SPECIAL,    100, 15, 100
	...
	move PRESENT,      EFFECT_ALL_UP_HIT,          60, DRAGON,       PHYSICAL,       100, 15, 100
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       80, DRAGON,        SPECIAL,    100, 20,  40
	...
	move MOONLIGHT,    EFFECT_HEAL,                0, NORMAL,        STATUS,     100,  5,   0
	...
	move CRUNCH,       EFFECT_DEFENSE_DOWN_HIT,   80, DARK,          PHYSICAL,    100, 15, 30
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  SPECIAL,    100, 15,   0
	move ROCK_SMASH,   EFFECT_FLINCH_HIT,         75, FIGHTING,      PHYSICAL,   100, 15,   34
