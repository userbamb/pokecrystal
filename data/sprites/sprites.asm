...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite ChrisBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_PINK
	...
	overworld_sprite MewSpriteGFX,  4, STILL_SPRITE, PAL_OW_RED
	overworld_sprite ChrisRunSpriteGFX, 12, WALKING_SPRITE, PAL_OW_PINK
 	overworld_sprite KrisRunSpriteGFX, 12, WALKING_SPRITE, PAL_OW_PINK
	overworld_sprite DiveSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN
