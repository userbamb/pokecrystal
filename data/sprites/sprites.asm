...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite ZapdosSpriteGFX, 8, STANDING_SPRITE, PAL_OW_RED
	...
	overworld_sprite TotoSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite CikoSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite CindSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
