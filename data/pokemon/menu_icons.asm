...
MonMenuIcons:
	...
	db ICON_FOX      ; SUNKERN RINRIN
	db ICON_FOX      ; SUNFLORA BELLRUN
	db ICON_BUG         ; YANMA
	db ICON_MONSTER     ; WOOPER
	db ICON_MONSTER     ; QUAGSIRE
	db ICON_FOX         ; ESPEON
	db ICON_FOX         ; UMBREON
	db ICON_FOX       ; MURKROW LEAFEON
	db ICON_SLOWPOKE    ; SLOWKING
	db ICON_ODDISH       ; MISDREAVUS GELANIA
	db ICON_UNOWN       ; UNOWN
	db ICON_GHOST       ; WOBBUFFET
	db ICON_EQUINE      ; GIRAFARIG
	db ICON_BUG         ; PINECO
	db ICON_BUG         ; FORRETRESS
	db ICON_FOX     ; DUNSPARCE KOTORA
	db ICON_FOX         ; GLIGAR RAITORA
	...
	db ICON_MONSTER       ; CORSOLA WOLFAN
	db ICON_MONSTER       ; REMORAID WARWOLF
	db ICON_FISH        ; OCTILLERY REMORAID
	db ICON_FISH     ; DELIBIRD  OCTILLERY
