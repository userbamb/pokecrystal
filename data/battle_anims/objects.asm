...
; ANIM_OBJ_SPEED_LINE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_81, BATTLEANIMFUNC_SPEED_LINE, PAL_BATTLE_OB_BLUE, ANIM_GFX_SPEED
; ANIM_OBJ_SHARPEN
...
; ANIM_OBJ_FORESIGHT
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_AA, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_SHINE
; ANIM_OBJ_RAPID_SPIN
