...
; ANIM_OBJ_STRENGTH
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_48, BATTLEANIMFUNC_RAZOR_WIND, PAL_BATTLE_OB_YELLOW, ANIM_GFX_WHIP
...
; ANIM_OBJ_RAZOR_WIND2
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_51, BATTLEANIMFUNC_MOVE_UP, PAL_BATTLE_OB_GREEN, ANIM_GFX_SPEED
