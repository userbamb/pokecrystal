...
MonicaGroup:
	...
	db  9, DODUO
		...
		db NO_ITEM
		db MUD_SLAP, PECK, GROWL, NO_MOVE
	db  8, PIDGEY
		db ATKDEFDV_SHINY, SPDSPCDV_SHINY ; atk|def, spd|spc
		dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
		db SHARP_BEAK
		db SAND_ATTACK, TACKLE, NO_MOVE, NO_MOVE
	db $fe ; delimiter
	...
	db  13, DODUO
		...
		dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
		db NO_ITEM
		db MUD_SLAP, PECK, GROWL, FURY_ATTACK
	db  14, PIDGEY
		db ATKDEFDV_SHINY, SPDSPCDV_SHINY ; atk|def, spd|spc
		dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
		db SHARP_BEAK
		db SAND_ATTACK, TACKLE, GUST, NO_MOVE
	db $fe ; delimiter
