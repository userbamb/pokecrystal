...
BrockGroup:
	...
	db 61, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	...
	db 69, SHUCKLE,    DEFENSE_CURL, LEECH_LIFE, ROLLOUT, ENCORE
	db -1 ; end
...
MistyGroup:
	...
	db 64, POLITOED,     SURF, PROTECT, BLIZZARD, RAIN_DANCE
	db 62, TOGETIC,    METRONOME, SOFTBOILED, FLAMETHROWER, PSYCHIC_M
    db -1 ; end
...
LtSurgeGroup:
	...
	db 69, GLIGAR,     CRUNCH, EXTREMESPEED, THUNDER, PROTECT
	db -1 ; end
...
ErikaGroup: ;CHAIN
	...
	db 66, VICTREEBEL, SUNNY_DAY, SYNTHESIS, SLUDGE, VINE_WHIP
	db 66, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db 60, FURRET, LEECH_SEED, CUT, VINE_WHIP, SYNTHESIS
	db 68, FORRETRESS, LEECH_SEED, PROTECT, RAPID_SPIN, EXPLOSION
	db -1 ; end

JanineGroup: ;CHAIN
	; JANINE (1)
	db "JANINE@", TRAINERTYPE_MOVES
	db 66, CROBAT,     SCREECH, SUPERSONIC, CONFUSE_RAY, FLY
	db 66, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 66, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 63, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	db 69, VENOMOTH,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db 68, MUK,  EARTHQUAKE, SLUDGE_BOMB, TOXIC, EXPLOSION
	db -1 ; end
...
SabrinaGroup: ;CHAIN
	...
	db 69, HYPNO,     PSYCHIC_M, HYPNOSIS, DREAM_EATER, PROTECT
	db 67, JYNX,     ICE_BEAM, LOVELY_KISS, ATTRACT, PSYCHIC_M
	db 66, GIRAFARIG,     HYPER_BEAM, CONFUSE_RAY, SWIFT, PSYCHIC_M
	db -1 ; end
...
BlaineGroup: ;CHAIN
	...
	db 70, ARCANINE,   EXTREMESPEED, MORNING_SUN, EMBER, FIRE_BLAST
	db 65, DELIBIRD,   FLAMETHROWER, OCTAZOOKA, HYPER_BEAM, DYNAMICPUNCH
	db 67, HOUNDOOM,   CRUNCH, PURSUIT, FIRE_BLAST, EMBER
	db -1 ; end
...
BlueGroup:  ;CHAIN
	...
	db 82, SCIZOR,  BATON_PASS, METAL_CLAW, ROCK_SMASH, SLASH
	db 83, PORYGON2,   TRI_ATTACK, RECOVER, THUNDER_WAVE, HYPER_BEAM
	db -1 ; end
