...
Rival1Group:
	...
	db 32, SNEASEL,    EMBER, EXTREMESPEED, BITE, FAINT_ATTACK
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    EMBER, EXTREMESPEED, BITE, FAINT_ATTACK
...
KarenGroup:
	...
	db 44, SNEASEL,    EXTREMESPEED, EMBER, PURSUIT, FAINT_ATTACK
...
Rival2Group:
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, SNEASEL,    EMBER, EXTREMESPEED, BITE, FAINT_ATTACK
...
; 9 Badge 10
	...
	db  54, SCIZOR
		...
		dw $0000, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP ; hp, atk, def, spd, spc
		db LEFTOVERS
		db FLY, ROCK_SMASH, PROTECT, METAL_CLAW
    db $fe ; DELIMITER
